...
from hengline.agent.api.api_medical_agent import RemoteAPIMedicalAgent
...
class MedicalAgentFactory:
    ...
    def create_agent(agent_type: str) -> object:
        ...
        if agent_type == "ollama":
            return OllamaMedicalAgent()
        elif agent_type == "vllm":
            return VLLMMedicalAgent()
        elif agent_type == "api" or agent_type == "remote_api":
            return RemoteAPIMedicalAgent()
        elif agent_type == "generative":
            return GenerativeMedicalAgent()
        else:
...
def main():
    ...
    try:
        ...
        agent = MedicalAgentFactory.create_agent(args.type)
